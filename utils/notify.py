...
if __name__ == '__main__':
    a = parse_smtp_uri("SMTP_URI=smtp_ssl://visonman:mgbdsmzeysdacaij@smtp.qq.com:25")
    "{'host': 'smtp.qq.com', 'port': 25, 'is_ssl': True, 'user': 'visonman@qq.com', 'password': 'mgbdsmzeysdacaij'}"
    # SMTP_URI=smtp://ivan-me:hanzhichao123@smtp.163.com:25
    # "SMTP_URI=smtp://visonman:mgbdsmzeysdacaij@smtp.qq.com"
    # 'SMTP_URI = smtp: // user: password @ smtp_server:port'
    print(a)
